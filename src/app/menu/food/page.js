    ...
    <>
      ...
      <section className="mx-5 my-4 gap-3 flex flex-col items-start">
        ...
        <p className="text-[18px] font-normal">
          ...
          به صورت خرد شده و همراه با گوشت و ادویه‌ها در قورمه سبزی استفاده
          می‌شوند.
        </p>
      </section>
      ...
      <section>
        ...
        <div className="mx-5">
          ...
          >
            ...
            <li>
              نخود پخته، تخم گشنیز، پودر تخم گشنیز، پودر لیمو عمانی، نمک و فلفل
              را اضافه کنید.
            </li>
            <li>
            ...
            <li>
              با حرارت ملایم بگذارید ۱-۱.۵ ساعت بپزد تا جا بیفتد. اگر آب کم بود،
              اضافه کنید.
            </li>
            <li>
              در آخر، برای غلظت می‌توانید کمی آرد نخودچی حل‌شده در آب سرد اضافه
              کنید.
            </li>
          </ol>
        </div>
